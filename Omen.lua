...
function Omen:SetupOptions()
	...
	self.optionsFrames = {}
	self.optionsFrames.Omen,catID = ACD3:AddToBlizOptions("Omen", self.versionstring, nil, "General")
...
function Omen:ShowConfig()
	...
	--Settings.OpenToCategory(self.optionsFrames.Profiles)
	--InterfaceOptionsFrame_OpenToCategory(self.optionsFrames.Omen)
	--Settings.OpenToCategory(self.optionsFrames.Omen)
end
